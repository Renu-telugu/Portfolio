  ...
  if (viewMoreCerts && moreCertificates) {
    viewMoreCerts.addEventListener("click", () => {
      ...
      if (moreCertificates.classList.contains("hidden")) {
        viewMoreCerts.innerHTML =
          'View More Certificates <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>';
      } else {
        viewMoreCerts.innerHTML =
          'View Less Certificates <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg>';
